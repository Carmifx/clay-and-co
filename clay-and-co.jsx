...
export default function ClayAndCo() {
  ...
  const [checkoutStep, setCheckoutStep] = useState("cart"); // cart -> shipping -> confirmed
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: 28, alignItems: "center", fontSize: 14 }}>
          <span style={{ display: window.innerWidth < 640 ? "none" : "inline" }}>Shop</span>
          <span style={{ display: window.innerWidth < 640 ? "none" : "inline" }}>Process</span>
          <span style={{ display: window.innerWidth < 640 ? "none" : "inline" }}>Visit</span>
